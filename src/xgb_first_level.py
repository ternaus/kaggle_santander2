...
class XgbWrapper(object):
    ...
    def train(self, x_train, y_train, seed, x_val, y_val):
        ...
        self.param['seed'] = seed
        dval = xgb.DMatrix(csr_matrix(x_val), label=y_val)
...
oof_train.to_csv('oof/xgb_train_13.csv', index=False)
...
oof_test.to_csv('oof/xgb_test_13.csv', index=False)
...
submission.to_csv('submissions/xgb_sub_13.csv', index=False)
